...
public class FlakyTests : AbstractTargetedAbility
{
    public FlakyTests(ICharacter character) : base(
        ...
        "Flaky Tests - Ultimate Ability \nProfessor Rig-Bee runs a flaky test on an enemy. If it passes, the enemy takes 200% of his attack stat. If the test fails, Rig-bee gets the \"Angry\" effect which buffs his attack stat.")
    { }
